    ...
    public partial class init1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LawyerCases", x => new { x.LawyerId, x.CaseId });
                    table.ForeignKey(
                        name: "FK_LawyerCases_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "Cases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LawyerCases_Lawyers_LawyerId",
                        column: x => x.LawyerId,
