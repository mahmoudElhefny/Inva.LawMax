...
namespace Inva.LawMax.Migrations
{
    ...
    [Migration("20240613061154_foreinkkey")]
    partial class foreinkkey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inva.LawMax.Cases.Case", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Inva.LawMax.Hearings.Hearing", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Inva.LawMax.LawyerCases.LawyerCase", b =>
                {
                    ...
                    b.HasKey("LawyerId", "CaseId");

                    b.HasIndex("CaseId");

                    b.ToTable("LawyerCases", (string)null);
                });

            modelBuilder.Entity("Inva.LawMax.Lawyers.Lawyer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Inva.LawMax.Hearings.Hearing", b =>
                {
                    b.HasOne("Inva.LawMax.Cases.Case", "Case")
                        .WithMany("Hearings")
            ...
            modelBuilder.Entity("Inva.LawMax.LawyerCases.LawyerCase", b =>
                {
                    ...
                    b.HasOne("Inva.LawMax.Lawyers.Lawyer", "Lawyer")
                        .WithMany("LawyerCases")
